...
PEA_ETFS = {
    ...
    "PANX.PA": {"name": "Amundi Nasdaq-100 PEA", "replication": "synthetic"},
    "PSP5.PA": {"name": "Amundi S&P 500 PEA", "replication": "synthetic"},
    "ESE.PA": {"name": "BNP Paribas Easy S&P 500", "replication": "synthetic"},
    "CACX.PA": {"name": "Amundi CAC 40", "replication": "physical"},
    "PCEU.PA": {"name": "Amundi Stoxx Europe 600", "replication": "physical"},
